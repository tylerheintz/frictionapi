...
class RelationshipsControllerTest < ActionController::TestCase
  ...
  test "should create relationship" do
    assert_difference('Relationship.count') do
      post :create, relationship: { accepted: @relationship.accepted, recipient_id: @relationship.recipient_id, requester_id: @relationship.requester_id }
    end
  ...
  test "should update relationship" do
    patch :update, id: @relationship, relationship: { accepted: @relationship.accepted, recipient_id: @relationship.recipient_id, requester_id: @relationship.requester_id }
    assert_redirected_to relationship_path(assigns(:relationship))
  end
